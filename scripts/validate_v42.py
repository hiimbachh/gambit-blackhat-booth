"""Reopen v4.2, check preservation and clip timing; never save test mutations."""
...
s=bpy.context.scene;OUT=ROOT/'Deliverables/v4.2'
...
audit=json.loads((OUT/'preservation.json').read_text())
assert all(digest(material(s.objects[n].active_material))==v for n,v in audit['roof_media_baseline'].items())
